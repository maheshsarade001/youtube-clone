...
import YT_Mobile_Logo from "../images/yt-logo-mobile.png";
...
function Header() {
  ...
  return (
    <div className="h-14">
      <div className="fixed w-full pt-4 top-0 z-30 flex flex-row items-center justify-between h-[inherit] px-4 md:px-5 bg-white dark:bg-black pb-3">
        {loading && <Loader />}
        ...
        <div className=" flex h-5 items-center">
          ...
          <Link to="/" className="flex items-center">
            <img
              className=" h-5 hidden dark:md:block "
              src={YT_Logo}
              alt="Youtube"
            />
            <img
