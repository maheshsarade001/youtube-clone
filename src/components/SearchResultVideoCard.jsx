...
const SearchResultVideoCard = ({ video }) => {
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/10 rounded-xl p-4">
        ...
        <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
          ...
          <span className="empty:hidden text-sm line-clamp-1 md:line-clamp-2 text-white/70 md:pr-24 md:my-4">
          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex text-sm font-semibold text-white/70 truncate overflow-hidden">
                {" "}
